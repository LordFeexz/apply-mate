declare module "midtrans-client" {
  ...
  export type EWalletActionResp =
    | {
        name: "generate-qr-code" | "deeplink-redirect" | "get-status";
        method: "GET";
        url: string;
      }
    | {
  ...
  export interface ChargeParameter {
    ...
    gopay?: GopayChargePayload;
    shoppepay?: ShoppePayChargePayload;
  }

  export interface GopayChargePayload {
  ...
  export interface ShoppePayChargePayload {
    callback_url?: string;
  }
